...
public class SigirPubmedRecallExperimenterOptimizedBoosting2017 extends SuperSigirPubmedRecallExperimenter {
    ...
    Map<String, String> templateProperties = SigirParameters.SIGIR19_HPIPUBNONE_WEIGHTS;
        templateProperties.put("pm_class_field", "pmclass2018lstmgru.keyword" );
