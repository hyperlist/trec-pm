                    ...
                    for (double kwb = .4; kwb < 2; kwb += .4) {
                        for (double meshb = .4; meshb < 2; meshb += .4) {
                            for (double genesb = .4; genesb < 2; genesb += .4) {
                                templateProperties.put("title_boost", String.valueOf(titb));
                                templateProperties.put("abstract_boost", String.valueOf(abstrb));
                                templateProperties.put("keyword_boost", String.valueOf(kwb));
                                templateProperties.put("meshTags_boost", String.valueOf(meshb));
                                templateProperties.put("genes_field_boost", String.valueOf(genesb));
