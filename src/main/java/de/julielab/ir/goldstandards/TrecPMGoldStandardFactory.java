...
public final class TrecPMGoldStandardFactory {
    ...
    public static TrecQrelGoldStandard<Topic> trialsOfficial2017() {
        ...
        return gs(Task.CLINICAL_TRIALS, 2017, GoldStandardType.OFFICIAL,
                new File(TrecPMGoldStandardFactory.class.getResource("/gold-standard/qrels-treceval-clinical_trials.2017.txt").getPath()), new File("config", "costosys-ct1718.xml"));
    }
    ...
    public static TrecQrelGoldStandard<Topic> trialsInternal2019() {
        return gs(Task.CLINICAL_TRIALS, 2019, GoldStandardType.INTERNAL,
                new File(TrecPMGoldStandardFactory.class.getResource("/internal/gold-standard/gsheets-trials-2019.qrels").getPath()), new File("config", "costosys-ct19.xml"));
    }

    public static TrecQrelGoldStandard<Topic> pubmedOfficial2017() {
        return gs(Task.PUBMED, 2017, GoldStandardType.OFFICIAL,
                new File(TrecPMGoldStandardFactory.class.getResource("/gold-standard/sample-qrels-final-abstracts.2017.txt").getPath()), new File("config", "costosys-pm1718.xml"));
    }

    public static TrecQrelGoldStandard<Topic> pubmedOfficial2018() {
        return gs(Task.PUBMED, 2018, GoldStandardType.OFFICIAL,
                new File(TrecPMGoldStandardFactory.class.getResource("/gold-standard/qrels-sample-abstracts.2018.txt").getPath()), new File("config", "costosys-pm1718.xml"));
    }

    public static TrecQrelGoldStandard<Topic> pubmedOfficial2019() {
        return gs(Task.PUBMED, 2019, GoldStandardType.OFFICIAL,
                new File(TrecPMGoldStandardFactory.class.getResource("/gold-standard/qrels-sampleval-abstracts.2019.txt").getPath()), new File("config", "costosys-pm19.xml"));
    }
    ...
    public static TrecQrelGoldStandard<Topic> pubmedInternal2019() {
        return gs(Task.PUBMED, 2019, GoldStandardType.INTERNAL,
                new File(TrecPMGoldStandardFactory.class.getResource("/internal/gold-standard/gsheets-abstracts-2019.qrels").getPath()), new File("config", "costosys-pm19.xml"));
    }
     ...
     * @return
     */
    private static TrecQrelGoldStandard<Topic> gs(Task task, int year, GoldStandardType type, File qrels, File documentDbConfiguration) {
