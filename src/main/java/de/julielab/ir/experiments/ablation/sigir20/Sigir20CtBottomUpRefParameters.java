...
public class Sigir20CtBottomUpRefParameters extends HashMap<String, String> {
    public Sigir20CtBottomUpRefParameters() {
        ...
        put("retrievalparameters.templateparameters.fieldboosts.conditions_field_disease_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.conditions_field_gene_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.conditions_field_kw_boost", "1.0");
        ...
        put("retrievalparameters.templateparameters.fieldboosts.keywords_field_disease_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.keywords_field_gene_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.keywords_field_kw_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.meshTags_field_disease_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.meshTags_field_gene_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.meshTags_field_kw_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.official_title_field_disease_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.official_title_field_gene_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.official_title_field_kw_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.outcomeDescriptions_field_disease_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.outcomeDescriptions_field_gene_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.outcomeDescriptions_field_kw_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.outcomeMeasures_field_disease_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.outcomeMeasures_field_gene_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.outcomeMeasures_field_kw_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.summary_field_disease_boost", "1.0");
        put("retrievalparameters.templateparameters.fieldboosts.summary_field_gene_boost", "1.0");
