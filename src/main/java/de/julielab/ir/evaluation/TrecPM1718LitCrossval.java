...
public class TrecPM1718LitCrossval {
    ...
    public static void main(String args[]) throws ConfigurationException, IOException {
        ...
        final TrecPmRetrieval retrieval = new TrecPmRetrieval().withTarget(Task.PUBMED).withYear(2017).withResultsDir("myresultsdir/").withSubTemplate(noClassifierTemplate).withGeneSynonym().withDiseaseSynonym();
